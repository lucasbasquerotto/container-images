...
```
docker run -d --name bind9 -p 53:53 -p 53:53/udp -v /absolute/path/named.conf:/etc/bind/named.conf -v /absolute/path/example.com.db:/etc/bind/example.com.db lucasbasquerotto/bind9:latest
```
